<div class="wrapper">
    ...
    $dados = $pagination->createLinks(array('id_tarefa', 'nome','descricao','data_cadastro', 'ultima_atualizacao', 'status'), 'tarefas', $busca, array('id_tarefa'), array('DESC'), 20, 0, $pag, $return_page);
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
            <span class="pull-left" style="margin-right: 10px">Tarefas</span>
            </h1>
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px" class="no-sort">Últ. atualização</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr id="dado_lista<?php echo $value['id_tarefa'];?>">
                                        <td><?php echo $value['id_tarefa']?></td>
                                        <td>
                                            <a href="<?php echo PL_PATH_ADMIN.'/tarefas_edita/'.$value['id_tarefa']?>">
                                                <?php
                                                echo $value['nome'];
                                                ?>
                                            </a>
                                        ...
                                        <td><?php echo convert_data($value['ultima_atualizacao'])?></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="<?php echo PL_PATH_ADMIN.'/tarefas_edita/'.$value['id_tarefa']?>"><i class="fa fa-pencil"></i> Editar</a></li>
                                                    
                                                    <li class="li_status">
                                                        <a href="javascript:void(0);" class="<?php echo $href_class; ?> link_status" onclick="status('tarefas',<?php echo $value['id_tarefa'];?>);"><i class="fa fa-check-circle-o"></i> <?php echo $href_text; ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);" class="text-red" onclick="deleta('tarefas',<?php echo $value['id_tarefa'];?>);"><i class="fa fa-times"></i> Excluir</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
